       ...
       <tr>
          <td>
             <table   border="0" align="left">
                <tr>
                   <td colspan="2" class="${modelUc.editclassSeqName}" id="seqMstName----${modelUc.ucId}----${modelUc.seqMstId}" style="word-wrap:break-word;font-family:times;color:#98bf21;font-size:24px;font-weight: bold;text-align: center;" >${modelUc.seqName} </td>
                   <td style="word-wrap:break-word;font-family:times;color:black;font-size:20px;font-weight: bold;text-align: center;">
    ...
    <table align="center" border="0" width=70%>
       <tr>
          <td>
             <table border="0" align="left">
                <tr>
                   <td colspan="2" class="${modelUc.editclass}" id="seqMstName----${modelUc.ucId}----${modelUc.seqMstId}" style="word-wrap:break-word;font-family:times;color:#98bf21;font-size:24px;font-weight: bold;text-align: center;">${modelUc.seqName}</td>
                   <td style="word-wrap:break-word;font-family:times;color:black;font-size:20px;font-weight: bold;text-align: center;">
                      <div >(${modelUc.sequeneVersionTitle}) <span>${modelUc.ucSeqMst.changeTitle}  ${modelUc.ucSeqMst.changeNote}</span></div>
                   </td>
                </tr>
