...
<div id="container">
    ...
    <form id="subscription_order_form" action="Properties.htm" method="post" >
        ...
        <table align="center" border="0" width=80%>
            ...
            <tr>
                <td colspan="2"><label for="description">Description</label>&nbsp;&nbsp;&nbsp;<font color="red" size="1px">${modelUc.descMessage}</font></td>
            ...
            <c:if test="${modelUc.propertyFor=='system'}">
                <tr>
                    <td colspan="3"><label for="hostCluster">Host Cluster</label>&nbsp;&nbsp;&nbsp;<font color="red"  size="1px">${modelUc.hostClusterMessage}</font>
            ...
            <c:if test="${modelUc.propertyFor!='system'}">
                <tr>
                    <td colspan="3"><label for="sample">Sample ${modelUc.propertyFor}</label>&nbsp;&nbsp;&nbsp;<font color="red" size="1px" >${modelUc.sampleMessage}</font></td>
                </tr>
                <tr>
                ...
                <c:if test="${modelUc.propertyFor=='response'}">
                    <tr>
                        <td colspan="3"><label for="sample">Sample failure ${modelUc.propertyFor}</label>&nbsp;&nbsp;&nbsp;<font color="red"  size="1px">${modelUc.sampleFailureMessage}</font></td>
                    </tr>
                    <tr>
                ...
                <c:if test="${ fn:containsIgnoreCase(modelUc.systemType, 'portal')  or fn:containsIgnoreCase(modelUc.systemType, 'application_server') or fn:containsIgnoreCase(modelUc.systemType, 'phone_app')}">
                    <c:if test="${modelUc.propertyFor=='request'}">
                        <tr>
                            <td colspan="3"><label for="imageUrl">Image Url</label>&nbsp;&nbsp;&nbsp;<font color="red"  size="1px">${modelUc.urlMessage}</font></td>
                        </tr>
                        <tr>
                    ...
                    <c:if test="${modelUc.propertyFor=='response'}">
                        <tr>
                            <td colspan="3"><label for="imageUrl">Image Url Success Response</label>&nbsp;&nbsp;&nbsp;<font color="red"  size="1px">${modelUc.urlMessage}</font></td>
                        </tr>
                        <tr>
                            <td colspan="3"><input id="imageUrl" name="imageUrl" type="text" size="100" maxlength="1900" value="${modelUc.imageUrl}" /></td>
                        </tr>
                        <tr>
                            <td colspan="3"><label for="failureImageUrl">Image Url Failure Response</label>&nbsp;&nbsp;&nbsp;<font color="red"  size="1px">${modelUc.urlMessage}</font></td>
                        </tr>
                        <tr>
