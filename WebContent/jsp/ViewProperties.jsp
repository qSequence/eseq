...
<div id="response_prop_menu">
  ...
  <c:if test="${fn:containsIgnoreCase(modelUc.systemType, 'sys_seq') and modelUc.copyProperties!='true'}">
      <c:if test="${modelUc.userReadAccess=='true'}">
          <div class="row">
              <div class="column" id="new_propName" class="${modelUc.editclass}">
                <b><a target="_blank" href="${modelUc.CONTEXT_PATH}/ViewInterface.htm?seq_mst_id_param=${modelUc.ucSeqMst.seqMstId}&requestId=${modelUc.requestId}&responseId=${modelUc.responseId}&sequenceVersion=UNKNOWN_${modelUc.sequenceVersion}&systemId=${modelUc.systemId}&propertyFor=${modelUc.propertyFor}">View Interface</a></b>
              </div>
          </div>
          <div class="row">
