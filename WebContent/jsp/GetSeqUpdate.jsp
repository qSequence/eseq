	...
	<!-- TD 1-->
									  ...
									  <td height="15%" width="15%" style="vertical-align: top;text-align: left;">
												...
												<c:if test="${col.ucSeqDiagram.expanded=='true'}">
													<a class="mousetoHand" src="images/nav/minus.png" alt="close" onclick="seqUpdateOpenClose( 'close_tree_node', '${modelUc.sequenceVersion}', '${col.ucSeqDiagram.seqMstId}', ${col.ucSeqDiagram.rowNo}, ${col.ucSeqDiagram.colNo}, '<c:url value="/GetSeqUpdate.htm" />', '${col.ucSeqDiagram.sysSeqId}');"><i class="fas fa-minus-circle"></i></a>
												</c:if>
												<c:if test="${col.ucSeqDiagram.expanded!='true'}">
													<a   class="mousetoHand" src="images/nav/plus.png" alt="open" onclick="seqUpdateOpenClose( 'expand_tree_node', '${modelUc.sequenceVersion}', '${col.ucSeqDiagram.seqMstId}', ${col.ucSeqDiagram.rowNo}, ${col.ucSeqDiagram.colNo}, '<c:url value="/GetSeqUpdate.htm" />', '${col.ucSeqDiagram.sysSeqId}');"><i class="fas fa-minus-circle"></i></a>
												</c:if>
										</td>
	<!-- TD 2-->
									  <c:if test="${col.ucSeqDiagram.asynchSourceDestination!=null and col.ucSeqDiagram.asynchSourceDestination=='SOURCE'}">
