	...
	<!-- TD 1-->
									  ...
									  <td height="15%" width="15%" style="vertical-align: top;text-align: left;">
												...
												<c:if test="${modelUc.sysObj.ucSeqDiagram.expanded=='true'}">
													<img  class="mousetoHand" src="images/nav/minus.png" alt="close" onclick="seqUpdateOpenClose( 'close_tree_node', '${modelUc.sequenceVersion}', ${modelUc.sysObj.ucSeqDiagram.seqMstId}, ${modelUc.sysObj.ucSeqDiagram.rowNo}, ${modelUc.sysObj.ucSeqDiagram.colNo}, '<c:url value="/GetSeqUpdate.htm" />', ${modelUc.sysObj.ucSeqDiagram.sysSeqId});"/>
												</c:if>
												<c:if test="${modelUc.sysObj.ucSeqDiagram.expanded!='true'}">
													<img   class="mousetoHand" src="images/nav/plus.png" alt="open" onclick="seqUpdateOpenClose( 'expand_tree_node', '${modelUc.sequenceVersion}', ${modelUc.sysObj.ucSeqDiagram.seqMstId}, ${modelUc.sysObj.ucSeqDiagram.rowNo}, ${modelUc.sysObj.ucSeqDiagram.colNo}, '<c:url value="/GetSeqUpdate.htm" />', ${modelUc.sysObj.ucSeqDiagram.sysSeqId});"/>
