...
public class GenEnveloped {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Document doc =
            dbf.newDocumentBuilder().parse(new FileInputStream("C:/aPPLICATIONS/app/Tomcat/webapps/data/DESIGN_552a1301-ef08-49ce-97ff-37e9d5511af6130903060239.doc"));
        ...
        OutputStream os;
        if (args.length > 1) {
           os = new FileOutputStream("C:/aPPLICATIONS/app/Tomcat/webapps/data/DESIGN_Sig.doc");
        } else {
           os = System.out;
        }
