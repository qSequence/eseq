...
row=row.substr(ind);
ind=row.indexOf("----");
row=row.substring(0,ind);
//alert(row);
var maxHeight=0;
			if($("#table_SYSTEM"+row).height()>maxHeight){
				maxHeight=$("#table_SYSTEM"+row).height();
			}
			if($("#table_SYSTEM_LAST_CONNECTOR"+row).height()>maxHeight){
				maxHeight=$("#table_SYSTEM_LAST_CONNECTOR"+row).height();
			}
			if($("#table_CROSS_OVER_LINE"+row).height()>maxHeight){
				maxHeight=$("#table_CROSS_OVER_LINE"+row).height();
			}
			if($("#table_CONNECTOR"+row).height()>maxHeight){
				maxHeight=$("#table_CONNECTOR"+row).height();
			}
			if($("#table_SYSTEM_CONNECTOR"+row).height()>maxHeight){
				maxHeight=$("#table_SYSTEM_CONNECTOR"+row).height();
			}
			$("#table_SYSTEM_CONNECTOR"+row).height(maxHeight);
			$("#table_CONNECTOR"+row).height(maxHeight);
			$("#table_CROSS_OVER_LINE"+row).height(maxHeight);
			$("#table_SYSTEM_LAST_CONNECTOR"+row).height(maxHeight);
			$("#table_SYSTEM"+row).height(maxHeight);
